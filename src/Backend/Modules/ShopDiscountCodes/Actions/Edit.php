...
use Frontend\Modules\ShopBase\Engine\Helper as FrontendShopDiscountCodesHelper;
...
class Edit extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        $this->record = BackendShopDiscountCodesModel::get($this->id);
    }
    ...
    protected function loadForm()
    {
        ...
        $this->frm->addText('discount', (float) $this->record['discount']);
    ...
    protected function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if(BackendShopDiscountCodesModel::existsByCode($fields['code']->getValue()) && $fields['code']->getValue() != $this->record['code']) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                BackendShopDiscountCodesModel::update($item);
