...
namespace Backend\Modules\ShopOrders\Engine;
...
class Model
{
    ...
    {
        BackendModel::get('database')->delete('shop_orders', 'id = ?', (int) $id);
    }
    ...
    public static function insert(array $item)
    {
        ...
        return (int) BackendModel::get('database')->insert('shop_orders', $item);
    }
    ...
    public static function update(array $item)
    {
        ...
        BackendModel::get('database')->update(
            'shop_orders', $item, 'id = ?', (int) $item['id']
        );
    }
}
