...
class Model
{
    const QRY_DATAGRID_BROWSE =
        'SELECT i.id, c.name, i.website
         ...
         INNER JOIN shop_brands_content as c  on i.id = c.brand_id
         WHERE c.language = ?';
    ...
    public static function delete($id)
    {
        ...
        BackendModel::get('database')->delete('shop_brands_content', 'brand_id = ?', (int) $id);
    ...
    public static function get($id)
    {
        ...
        $return['content'] = (array) $db->getRecords(
            'SELECT i.* FROM shop_brands_content AS i
            WHERE i.brand_id = ?',
    ...
    {
        BackendModel::get('database')->insert('shop_brands_content', $content);
    }
    ...
    public static function updateContent(array $content, $id)
    {
        ...
        {
            $db->update('shop_brands_content', $row, 'brand_id = ? AND language = ?', array($id, $language));
        }
    }
}
